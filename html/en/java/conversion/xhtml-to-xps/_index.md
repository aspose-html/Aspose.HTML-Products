...
description: Sample Java conversion code for XHTML format to XPS file. Use this example code to convert XHTML to XPS within any Web or Desktop Java based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert XHTML to XPS via Java" h2="High-fidelity conversion of XHTML pages as XPS using server-side Java library." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/html/aspose_html-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XHTML" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Developers can easily convert XHTML file to XPS in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="XHTML to XPS Java Conversion Source Code" offSpacer="" %}}

{{< gist "aspose-com-gists" "7f312c01ed7ae38aa545cfd17da3dab7" "convert-xhtml-to-xps.java" >}}
