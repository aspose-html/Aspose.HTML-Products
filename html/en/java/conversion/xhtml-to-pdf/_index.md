...
description: Sample Java conversion code for XHTML format to PDF file. Use this example code to convert XHTML to PDF within any Web or Desktop Java based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert XHTML to PDF via Java" h2="High-fidelity conversion of XHTML pages as PDF using server-side Java library." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/html/aspose_html-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XHTML" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert XHTML to PDF Using Java" %}}
 ...
 In order to render XHTML to PDF, we’ll use
...
{{% blocks/products/pf/agp/text %}}
 ...
 Developers can easily convert XHTML file to PDF in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="XHTML to PDF Java Conversion Source Code" offSpacer="" %}}

{{< gist "aspose-com-gists" "7f312c01ed7ae38aa545cfd17da3dab7" "convert-xhtml-to-pdf.java" >}}
