...
description: Sample Java conversion code for MHTML format to XPS file. Use this example code to convert MHTML to XPS within any Web or Desktop Java based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert MHTML to XPS via Java" h2="High-fidelity conversion of MHTML pages as XPS using server-side Java library." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/html/aspose_html-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MHTML" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Developers can easily convert MHTML file to XPS in just a few lines of code.
...
{{< gist "aspose-com-gists" "7f312c01ed7ae38aa545cfd17da3dab7" "convert-mhtml-to-xps.java" >}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="MHTML to XPS Conversion Live Demos" sectionDescription="[Convert MHTML to XPS](https://products.aspose.app/html/conversion/mhtml-to-xps) right now by visiting our Live Demos website.The live demo has the following benefits" >}}
