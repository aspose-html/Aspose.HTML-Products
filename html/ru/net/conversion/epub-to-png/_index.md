...
title: Преобразование EPUB в PNG — C#
description: Пример кода для преобразования EPUB в PNG C#. Легко используйте API преобразователя в ASP.NET или любом приложении .NET. Попробуйте онлайн-конвертер EPUB в PNG бесплатно!
...
{{<section banner>}}
---
h1: Конвертировать EPUB в PNG через C#
h2: Сгенерируйте PNG из исходного файла EPUB, используя .NET API. Мгновенно конвертируйте формат EPUB в PNG с помощью нашего бесплатного онлайн-конвертера!
---

{{<section overview>}}
---
h2: Преобразование EPUB в PNG с помощью C#
---
...
1. Используйте метод [ConvertEPUB()](https://apireference.aspose.com/html/net/aspose.html.converters.converter/convertepub/methods/27) класса Converter, чтобы сохранить EPUB в виде изображения PNG. . Вам необходимо передать файловый поток EPUB, ImageSaveOptions и путь к выходному файлу в метод ConvertEPUB() для преобразования EPUB в PNG.
