---
translation: true
title: HTML-Telefoneingangsgenerator – Online-Tool und C#-Code
template: /templates/_template-generators-child.md
description: Erstellen Sie eine HTML-Telefoneingabe für Ihre Website. Überprüfen Sie die Telefoneingabe, kopieren und verwenden Sie generierten HTML- und C#-Code in Ihrem Projekt!
url: /net/generators/telephone/
platformtag: net
generator: HTML-Telefoneingangsgenerator
element: HTML-Telefoneingabe
tag: Telefon
---

{{<section banner>}}
---
h1: HTML-Telefoneingangsgenerator
h2: Generieren Sie HTML- und C#-Code für ein HTML-Telefoneingabeelement und verwenden Sie es in Ihrer eigenen Website oder Ihrem C#-Projekt.
---

{{<section overview>}}
---
h2: Generieren Sie spontan eine HTML-Telefoneingabe!
---
...
<h2> HTML-Telefoneingabe in C# erstellen</h2>
...
{{<section steps>}}
---
h2: Schritte zum Erstellen von HTML-Telefoneingaben in C#
---
...
1. Verwenden Sie die Methode [SetAttribute()](https://reference.aspose.com/html/net/aspose.html.dom/element/setattribute/), um „Platzhalter“ oder andere unterstützte Attribute mit ihren Werten hinzuzufügen.
1. Kopieren Sie den C#-Code für die HTML-Telefoneingabe und verwenden Sie ihn in Ihrem C#-Projekt.
