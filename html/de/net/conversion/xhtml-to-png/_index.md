...
description: Konvertieren Sie XHTML in C# in PNG. Speichern Sie XHTML als PNG-Datei. Probieren Sie den XHTML to PNG Converter kostenlos online aus!
...
1. Verwenden Sie die Methode [ConvertHTML()](https://reference.aspose.com/html/net/aspose.html.converters/converter/converthtml/), um XHTML als PNG-Bild zu speichern. Sie müssen HTMLDocument, ImageSaveOptions und den Ausgabedateipfad an die ConvertHTML()-Methode übergeben.
