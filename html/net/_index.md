...
<div class="diagram1 d1-net">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img alt=".NET HTML Processing API" src="https://www.aspose.cloud/templates/aspose/App_Themes/V3/images/html/272x272/aspose_html-for-net.png"/>
  <header>
   Aspose.HTML
  </header>
  <footer>
...
<p>Aspose.HTML for .NET is capable of loading ePub and MHTML files to perform various operations including the conversion to fixed-layout and raster image formats.</p>
...
<h2 class="h2title">.NET Framework Versions Supported</h2>

<p>You can use Aspose.HTML for .NET to build any type of 32-bit or 64-bit .NET applications including ASP.NET, Web Services and WinForms for any .NET Framework version from 2.0 , 3.5, 4.0 and 4.0_ClientProfile in your favorite .NET languages like C# and VB.NET etc.</p>
