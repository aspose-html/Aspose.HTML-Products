...
description: Sample code for XHTML to BMP C# conversion. Use API example code for batch XHTML files to BMP conversion within VB.NET, Asp.NET or any .NET based application.
---
