...
description: Sample code for XHTML to MD C# conversion. Use API example code for batch XHTML files to MD conversion within VB.NET, Asp.NET or any .NET based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert XHTML to MD via C#" h2="High-fidelity conversion of XHTML pages as MD using server-side .NET APIs." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/html/aspose_html-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="MD" pfName="Aspose.Html" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XHTML" >}}
...
{{% blocks/products/pf/agp/code-block title="This sample code shows XHTML to MD C# Conversion" offSpacer="" %}}
