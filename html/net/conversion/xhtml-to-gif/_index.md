...
1.  Use the [ConvertHTML()](https://apireference.aspose.com/html/net/aspose.html.converters/converter/converthtml/) method to save XHTML as a GIF file. You need to pass the HTMLDocument, ImageSaveOptions, and output file path to the ConvertHTML() method.
...
{{< app/html/converter XHTML GIF DOCX BMP XPS TIFF PNG PDF "JPG|JPEG" >}}
using Aspose.Html;
...
{{< /blocks/products/pf/agp/other-supported-section >}}                                                       x
